...
function DetailPilihTanggalComponent(props: DetailPilihTanggalProps): any {
  ...
  const lap = [
    { id: 1, lapangan: 'Lapangan A', harga: 100000, url: 'https://lapanganfutsal.id/wp-content/uploads/2023/01/venus-futsal1.jpg', },
    { id: 2, lapangan: 'Lapangan B', harga: 100000, url: 'https://lapanganfutsal.id/wp-content/uploads/2023/01/venus-futsal1.jpg', },
    { id: 3, lapangan: 'Lapangan C', harga: 100000, url: 'https://lapanganfutsal.id/wp-content/uploads/2023/01/venus-futsal1.jpg', },
    { id: 4, lapangan: 'Lapangan D', harga: 100000, url: 'https://lapanganfutsal.id/wp-content/uploads/2023/01/venus-futsal1.jpg', },
    { id: 5, lapangan: 'Lapangan E', harga: 100000, url: 'https://lapanganfutsal.id/wp-content/uploads/2023/01/venus-futsal1.jpg', },
    { id: 6, lapangan: 'Lapangan F', harga: 100000, url: 'https://lapanganfutsal.id/wp-content/uploads/2023/01/venus-futsal1.jpg', },
    { id: 7, lapangan: 'Lapangan G', harga: 100000, url: 'https://lapanganfutsal.id/wp-content/uploads/2023/01/venus-futsal1.jpg', },
  ];
    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={{ ...elevation(3), borderColor: 'grey', padding: 10, flexDirection: 'row', backgroundColor: 'white', justifyContent: 'space-between' }}>
        ...
        <Pressable style={{ marginRight: 15, ...elevation(3), height: 50, borderRadius: 5, backgroundColor: '#0396a6', justifyContent: 'center', alignItems: 'center', }}
          onPress={() => {
            let data = {
              field: lap[selectedIndex]?.lapangan,
              price: lap[selectedIndex]?.harga
            }
            LibNavigation.navigate('detail/pilihjam', { data: data })
          }}>
