...
function m(props: UtilsSearchlistProps): any {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff', marginTop: STATUSBAR_HEIGHT }}>
      ...
      <View style={{ width: LibStyle.width, flexDirection: 'row', justifyContent: 'space-between', height: 60, backgroundColor: 'red' }}>
        <View style={{ backgroundColor: 'green', justifyContent: 'center', alignContent: 'center', alignItems: 'center', width: LibStyle.width / 4 }}>
          <Pressable onPress={() => {
